...
class Add extends BackendBaseActionAdd
{
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if (
                $this->frm->getField('player1')->getValue() == $this->frm->getField('player2')->getValue() &&
                $this->frm->getField('player1')->getValue() != ''
            ) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['date'] = BackendModel::getUTCDate(
                    null,
                    BackendModel::getUTCTimestamp($this->frm->getField('date'), $this->frm->getField('time'))
                );
