...
{form:edit}
  <div class="box">
    ...
    <div class="fullwidthOptions">
      ...
      <a href="{$var|geturl:'deletePlayer'}&amp;id={$item.id}" data-message-id="confirmDeletePlayer"
         class="askConfirmation button linkButton icon iconDelete">
        <span>{$lblDelete|ucfirst}</span>
      </a>

      <div class="buttonHolderRight">
        <input id="editButton" class="inputButton button mainButton" type="submit" name="add"
               value="{$lblEditPlayer|ucfirst}"/>
      </div>
    </div>
  </div>
